...
| Page | Description |
|------|-------------|
| `index.html` | Hero section with core skills and social links |
| `about.html` | Background, education summary, and highlights |
| `qualifications.html` | Education timeline, experience, technical skills, and certifications |
| `projects.html` | Showcase of 7 data science & AI projects |
| `achievements.html` | Academic awards, hackathon results, and leadership roles |
...
- **AI Chatbot:** Gemini 2.5 Flash API via a Vercel Serverless Function (`/api/chat.js`)
...
- **AI Portfolio Assistant** — Floating chatbot widget backed by Gemini 2.5 Flash; answers questions about skills, projects, and experience
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Anubhav%20Yadav-blue?logo=linkedin)](https://www.linkedin.com/in/anubhav-yadav-data-science/)
[![GitHub](https://img.shields.io/badge/GitHub-AnubhavDataSci25-black?logo=github)](https://github.com/AnubhavDataSci25)
[![Email](https://img.shields.io/badge/Email-anubhavyadav77ff%40gmail.com-red?logo=gmail)](mailto:anubhavyadav77ff@gmail.com)
